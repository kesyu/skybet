 ...
 *
 * Represents the application's /application & /bets request.
 * 
 */
@JsonInclude(Include.NON_NULL)
public class BetResponseType {
	...
	public BetResponseType() { };
	
	public BetResponseType(Integer bet_id, String event, String name, Float odds) {
		super();
		this.bet_id = bet_id;
		this.event = event;
		this.name = name;
	...
	public BetResponseType(Integer bet_id, String event, String name, Float odds, Integer stake, Integer transaction_id) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BetResponseType other = (BetResponseType) obj;
		if (bet_id == null) {
	...
	public String toString() {
		...
		builder.append("BetResponseType [bet_id=").append(bet_id).append(", event=").append(event).append(", name=")
